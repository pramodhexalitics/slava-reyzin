        ...
        <div className="home-wrapper">
            <div className="datenschutz-page">
                ...
                <div className="dtl-row">
                    ...
                    <p>Beim Besuch dieser Website kann Ihr Surf-Verhalten statistisch ausgewertet werden. Das geschieht vor allem mit sogenannten Analyseprogrammen. Detaillierte Informationen zu diesen Analyseprogrammen finden Sie in der folgende Datenschutzerklärung.</p>
                </div>
                <div className="dtl-row">
                    <h2>2. Hosting</h2>
                    ...
                    <h3>DomainFactory</h3>
                    <p>
                        Anbieter ist die DomainFactory GmbH, Oskar-Messter-Str. 33, 85737 Ismaning (nachfolgend
                        DomainFactory) Wenn Sie unsere Website besuchen, erfasst DomainFactory verschiedene Logfiles
                        inklusive Ihrer IP-Adressen.
                    </p>
                    <p>Details entnehmen Sie der Datenschutzerklärung von DomainFactory:</p>
                    <p>
                ...
                <div className="dtl-row">
                    ...
                    <p>Vyacheslav Reyzin</p>
                    <p>Max-Kohn-Str. 16</p>
                    <p>90451, Nürnberg</p>
                    <p className="mt-3">Telefon: 015788053838</p>
                    <p>E-Mail: slava@reyzin.de</p>
                    <p className="mt-3">
                ...
                <div className="dtl-row">
                    ...
                    <p>Wenn Sie den auf der Website angebotenen Newsletter beziehen möchten, benötigen wir von Ihnen eine E-Mail-Adresse sowie Informationen, welche uns die Überprüfung gestatten, dass Sie der Inhaber der angegebenen E-Mail-Adresse sind und mit dem Empfang des Newsletters einverstanden sind. Weitere
                    ...
                    <p>Nach Ihrer Austragung aus der Newsletterverteilerliste wird Ihre E-Mail-Adresse bei uns bzw. dem
                        ...
                        Art. 6 Abs. 1 lit. f DSGVO). Die Speicherung in der Blacklist ist zeitlich nicht befristet. <b>Sie können der
                            Speicherung widersprechen, sofern Ihre Interessen unser berechtigtes Interesse überwiegen.</b></p>
                </div>
                <div className="dtl-row">
